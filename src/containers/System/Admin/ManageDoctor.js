...
class ManageDoctor extends Component {
    ...
    buildDataInputSelect = (inputData, type) => {
        ...
        if (inputData && inputData.length > 0) {
            ...
            if (type === 'PRICE') {
                // console.log('Hoi dan it ', inputData);
                inputData.map((item, index) => {
                    let object = {};
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            ...
            console.log('123365877778888', dataSelectPrice, dataSelectPayment, dataSelectProvince);
    ...
    handleChangeSelectDoctorInfor = async (selectedOption, name) => {
        ...
        // console.log('Dang chien 123456789', selectedOption, stateName);
    };
    ...
    render() {
        let { hasOldData } = this.state;
        console.log('Lên check ', this.state);
